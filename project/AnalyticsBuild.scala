...
object AnalyticsBuild extends Build {
  //credentials += Credentials(Path.userHome / ".github.cred")

  /*credentials += Credentials("Github Repo",
    "https://github.com/sparklinedata", "jitender.aswani@gmail.com","R3p38t2015"
  )*/
  import BuildSettings._
  //lazy val reponame = RootProject(uri("https://github.com/sparklinedata/ETL.git"))
  ...
  ) aggregate (etl) //dependsOn(reponame)
